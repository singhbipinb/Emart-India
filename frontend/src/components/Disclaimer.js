...
class TermsConditions extends Component {
  ...
  render() {
    return (
      <div>
        <h1>Disclaimer for eMart India</h1>

        <p>
          If you require any more information or have any questions about our
          site's disclaimer, please feel free to contact us by email at
          bipin.singh.sd@mmumullana.org
        </p>

        <h2>Disclaimers for eMart India</h2>

        <p>
          All the information on this website - emart.in - is published in good
          faith and for general information purpose only. eMart India does not
          ...
          on this website (eMart India), is strictly at your own risk. eMart
          India will not be liable for any losses and/or damages in connection
          with the use of our website. Our Disclaimer was generated with the
          help of the{" "}
